...
function WatchHistory() {
  ...
  return (
    <>
      ...
      <h3>Watch History</h3>
       <Link to={'/home'}className='text-decoration-none text-white'> <i class="fa-solid fa-left-long me-2"></i> Back to Home</Link>
      </div>
      <table className="table mb-5 container shadow">
        <thead>
          <tr>
            ...
            <th>URL</th>
            <th>TimeStamp</th>
            <th><i class="fa-solid fa-ellipsis fa-beat"></i></th>
            </tr>
        </thead>
        <tbody>
